...
When /^(?:|I )press i18n "([^"]*)"(?: within "([^"]*)")?$/ do |button, selector|
  with_scope(selector) do
...
When /^(?:|I )follow i18n "([^"]*)"(?: within "([^"]*)")?$/ do |link, selector|
  with_scope(selector) do
...
When /^(?:|I )fill in "([^"]*)" for i18n "([^"]*)"(?: within "([^"]*)")?$/ do |value, field, selector|
  with_scope(selector) do
...
Then /^I should not see error$/ do
